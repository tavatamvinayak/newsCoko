...
function indiaNews ({ i ,urlToImage , title , description , url ,author }) {
  ...
  return (
    <>
      ...
      <div className="p-4 md:w-1/3 sm:mb-0 mb-6" key={i} >
        ...
        <p>{author}</p>
        <a className="text-indigo-500 inline-flex items-center mt-3  p-2 rounded-lg bg-[#ffeed6]" href={`${url}`}>Learn More
